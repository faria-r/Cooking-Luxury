  ...
  return (
    <div>
      ...
      <div className="text-center">
        ...
        <p>
          <span className="text-2xl text-rose-600">Faria's Cooking Luxury</span>{" "}
          Care About Beloved Customers.Book An Order and Get a{" "}
          <span className="text-xl text-rose-600">Free Drinks</span>!
        </p>
      </div>
      <Offers></Offers>
      <div>
